...
from ros2_ws.scripts.joint_state_recorder_the_bust2 import JointStatesRecorderTheBust2
import os
import argparse
import rclpy
...
if __name__ == "__main__":
    ...
    data_folder = os.path.join(absolute_path, "data", "the_bust2", save_folder_name)
    if data_folder and not os.path.exists(data_folder):
        os.makedirs(data_folder)

    rclpy.init()
    node = JointStatesRecorderTheBust2(data_folder)
    try:
        while rclpy.ok():
